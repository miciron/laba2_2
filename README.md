...
1. Git clone ````2. https://github.com/miciron/laba2_2````
3. Далее необходимо запустить проект внутри Android Studio:
...
* Нажав первую, вы запустите анимацию ````Rotation````.
* Нажав на вторую, вы хапустите анимацию ````Transalte````.
